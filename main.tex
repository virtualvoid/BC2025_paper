...
\ITAkeywords{\textit{document management system, workflow engine, microservices, records management, legislative compliance}}

\ITAacmccs{\textit{Write a suitable set of classification names...}}

\input{01-introduction}
\input{02-related-work}
\input{03-architecture}
\input{04-workflow-engine}
\input{05-compliance}
\input{06-discussion}
\input{07-conclusion}
