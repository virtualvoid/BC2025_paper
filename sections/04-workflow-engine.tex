...
\begin{figure}[H]
  ...
  \caption{Workflow engine high level model.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/process-detail.png}
  \caption{Example of a configurable workflow definition for invoice approval.}
  \label{fig:workflow-definition-example}
\end{figure}
...
Workflow modeling principles are consistent with records lifecycle management standards defined in ISO 15489 \cite{iso15489} and MoReq2010 requirements \cite{moreq2010}.
