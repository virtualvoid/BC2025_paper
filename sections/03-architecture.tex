...
The backend is implemented using the .NET 10 platform and is structured into multiple logical components responsible for records management, workflow execution, authentication, and supporting infrastructure services.
